namespace DocumentAtom.Excel
{
    ...
    /// <summary>
    /// Create atoms with hierarchical structure from Microsoft Excel .xlsx documents.
    /// Organizes atoms into a tree structure based on sheet (page) grouping, where the first atom on each sheet contains subordinate content as Quarks (child atoms).
    /// </summary>
    public class HierarchicalXlsxProcessor : ProcessorBase, IDisposable
    {
...
#pragma warning disable CS8600 // Converting null literal or possible null value to non-nullable type.
        ...
        /// <summary>
        /// Hierarchical xlsx processor settings.
        /// </summary>
        public new HierarchicalXlsxProcessorSettings Settings
        {
            get
            {
        ...
        private HierarchicalXlsxProcessorSettings _ProcessorSettings = new HierarchicalXlsxProcessorSettings();
        ...
        /// <summary>
        /// Create atoms with hierarchical structure from Excel documents.
        /// </summary>
        /// <param name="settings">Hierarchical processor settings.</param>
        /// <param name="imageSettings">Image processor settings.</param>
        public HierarchicalXlsxProcessor(HierarchicalXlsxProcessorSettings settings = null, ImageProcessorSettings imageSettings = null)
        {
            if (settings == null) settings = new HierarchicalXlsxProcessorSettings();

            Header = "[HierarchicalXlsx] ";
        ...
        /// <summary>
        /// Extract atoms from a file with hierarchical structure.
        /// </summary>
        /// <param name="filename">Filename.</param>
        /// <returns>Root-level atoms containing hierarchical structure via Quarks property.</returns>
