namespace Test.CsvProcessor
{
    ...
    public static class Program
    {
        ...
        private static CsvProcessorSettings _Settings = new CsvProcessorSettings();
        ...
        public static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                string rowsPerAtomStr = Inputty.GetString("Rows per atom (0=entire table):", "0", false);
                if (Int32.TryParse(rowsPerAtomStr, out int rowsPerAtom))
                {
                    _Settings.RowsPerAtom = rowsPerAtom;
                }
                ...
                using (Timestamp ts = new Timestamp())
                {
                    ...
                    using (CsvProcessor processor = new CsvProcessor(_Settings))
                    {
