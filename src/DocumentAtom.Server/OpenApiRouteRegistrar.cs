namespace DocumentAtom.Server
{
    ...
    internal static class OpenApiRouteRegistrar
    {
        ...
        {
            restServer.Routes.PreAuthentication.Static.Add(HttpMethod.HEAD, "/", routes.InstrumentRoute("/", routes.LoopbackRoute), routes.ExceptionRoute, openApiMetadata: HeadRootMetadata());
            restServer.Routes.PreAuthentication.Static.Add(HttpMethod.GET, "/", routes.InstrumentRoute("/", routes.RootRoute), routes.ExceptionRoute, openApiMetadata: RootMetadata());
            restServer.Routes.PreAuthentication.Static.Add(HttpMethod.HEAD, "/favicon.ico", routes.InstrumentRoute("/favicon.ico", routes.HeadFavicon), routes.ExceptionRoute, openApiMetadata: HeadFaviconMetadata());
            restServer.Routes.PreAuthentication.Static.Add(HttpMethod.GET, "/favicon.ico", routes.InstrumentRoute("/favicon.ico", routes.GetFavicon), routes.ExceptionRoute, openApiMetadata: GetFaviconMetadata());

            restServer.Routes.PreAuthentication.Static.Add(HttpMethod.POST, "/typedetect", routes.InstrumentRoute("/typedetect", imageRoutes.TypeDetectionRoute), routes.ExceptionRoute, openApiMetadata: TypeDetectionMetadata());
            restServer.Routes.PreAuthentication.Static.Add(HttpMethod.POST, "/atom/csv", routes.InstrumentRoute("/atom/csv", textRoutes.CsvAtomRoute), routes.ExceptionRoute, openApiMetadata: AtomMetadata("csvAtom", "Extract CSV atoms", "Extract tabular atoms from base64-encoded CSV content.", "Use RowDelimiter, ColumnDelimiter, HasHeaderRow, and RowsPerAtom for CSV-specific behavior."));
            restServer.Routes.PreAuthentication.Static.Add(HttpMethod.POST, "/atom/excel", routes.InstrumentRoute("/atom/excel", documentRoutes.ExcelAtomRoute), routes.ExceptionRoute, openApiMetadata: AtomMetadata("excelAtom", "Extract Excel atoms", "Extract worksheet, row, cell, and table-oriented atoms from base64-encoded XLSX workbook content.", "Use BuildHierarchy and HeaderRowScoreThreshold for workbook structure. Set ExtractAtomsFromImages to run OCR over embedded images."));
            restServer.Routes.PreAuthentication.Static.Add(HttpMethod.POST, "/atom/html", routes.InstrumentRoute("/atom/html", textRoutes.HtmlAtomRoute), routes.ExceptionRoute, openApiMetadata: AtomMetadata("htmlAtom", "Extract HTML atoms", "Extract atoms from base64-encoded HTML markup.", "Use ProcessInlineStyles, ProcessMetaTags, ProcessScripts, ProcessComments, PreserveWhitespace, MaxTextLength, ProcessSvg, ExtractDataAttributes, and BuildHierarchy for HTML-specific behavior."));
            restServer.Routes.PreAuthentication.Static.Add(HttpMethod.POST, "/atom/json", routes.InstrumentRoute("/atom/json", textRoutes.JsonAtomRoute), routes.ExceptionRoute, openApiMetadata: AtomMetadata("jsonAtom", "Extract JSON atoms", "Extract atoms from base64-encoded JSON content.", "Use BuildHierarchy and MaxDepth for nested JSON traversal."));
            restServer.Routes.PreAuthentication.Static.Add(HttpMethod.POST, "/atom/markdown", routes.InstrumentRoute("/atom/markdown", textRoutes.MarkdownAtomRoute), routes.ExceptionRoute, openApiMetadata: AtomMetadata("markdownAtom", "Extract Markdown atoms", "Extract atoms from base64-encoded Markdown content.", "Use Delimiters and BuildHierarchy to influence heading, list, table, and paragraph structure."));
            restServer.Routes.PreAuthentication.Static.Add(HttpMethod.POST, "/atom/ocr", routes.InstrumentRoute("/atom/ocr", imageRoutes.OcrAtomRoute), routes.ExceptionRoute, openApiMetadata: OcrMetadata());
            restServer.Routes.PreAuthentication.Static.Add(HttpMethod.POST, "/atom/pdf", routes.InstrumentRoute("/atom/pdf", documentRoutes.PdfAtomRoute), routes.ExceptionRoute, openApiMetadata: AtomMetadata("pdfAtom", "Extract PDF atoms", "Extract atoms from base64-encoded PDF data.", "Set ExtractAtomsFromImages to run OCR over images discovered while processing PDF pages."));
            restServer.Routes.PreAuthentication.Static.Add(HttpMethod.POST, "/atom/png", routes.InstrumentRoute("/atom/png", imageRoutes.PngAtomRoute), routes.ExceptionRoute, openApiMetadata: AtomMetadata("pngAtom", "Extract PNG atoms", "Extract atoms from base64-encoded PNG image data using OCR-backed image analysis.", "Use LineThreshold, ParagraphThreshold, HorizontalLineLength, VerticalLineLength, TableMinArea, ColumnAlignmentTolerance, and ProximityThreshold for image segmentation."));
            restServer.Routes.PreAuthentication.Static.Add(HttpMethod.POST, "/atom/powerpoint", routes.InstrumentRoute("/atom/powerpoint", documentRoutes.PowerPointAtomRoute), routes.ExceptionRoute, openApiMetadata: AtomMetadata("powerPointAtom", "Extract PowerPoint atoms", "Extract atoms from base64-encoded PPTX presentation content.", "Use BuildHierarchy for slide structure. Set ExtractAtomsFromImages to run OCR over embedded images."));
            restServer.Routes.PreAuthentication.Static.Add(HttpMethod.POST, "/atom/rtf", routes.InstrumentRoute("/atom/rtf", documentRoutes.RtfAtomRoute), routes.ExceptionRoute, openApiMetadata: AtomMetadata("rtfAtom", "Extract RTF atoms", "Extract atoms from base64-encoded RTF document content.", "Set ExtractAtomsFromImages to run OCR over images discovered while processing the document."));
            restServer.Routes.PreAuthentication.Static.Add(HttpMethod.POST, "/atom/text", routes.InstrumentRoute("/atom/text", textRoutes.TextAtomRoute), routes.ExceptionRoute, openApiMetadata: AtomMetadata("textAtom", "Extract text atoms", "Extract atoms from base64-encoded plain text data.", "Use Delimiters to split content and Chunking to attach chunk output to returned atoms."));
            restServer.Routes.PreAuthentication.Static.Add(HttpMethod.POST, "/atom/word", routes.InstrumentRoute("/atom/word", documentRoutes.WordAtomRoute), routes.ExceptionRoute, openApiMetadata: AtomMetadata("wordAtom", "Extract Word atoms", "Extract atoms from base64-encoded DOCX document content.", "Use BuildHierarchy for document structure. Set ExtractAtomsFromImages to run OCR over embedded images."));
            restServer.Routes.PreAuthentication.Static.Add(HttpMethod.POST, "/atom/xml", routes.InstrumentRoute("/atom/xml", textRoutes.XmlAtomRoute), routes.ExceptionRoute, openApiMetadata: AtomMetadata("xmlAtom", "Extract XML atoms", "Extract atoms from base64-encoded XML content.", "Use BuildHierarchy, MaxDepth, IncludeAttributes, and PreserveWhitespace for XML traversal."));
        }
