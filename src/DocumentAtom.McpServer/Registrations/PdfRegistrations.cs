namespace DocumentAtom.McpServer.Registrations
{
    ...
    /// <summary>
    /// Registration methods for PDF operations.
    /// </summary>
    public static class PdfRegistrations
    {
        ...
        /// <summary>
        /// Registers PDF tools on HTTP server.
        /// </summary>
        ...
        public static void RegisterHttpTools(McpHttpServer server, DocumentAtomSdk sdk, Serializer serializer)
        {
            server.RegisterTool(
                "pdf/process",
                "Process a PDF file and extract atoms",
                new
                {
                    type = "object",
                    properties = new
                    {
                        data = new { type = "string", description = "Base64-encoded PDF file data" },
                ...
                (args) =>
                {
                    ...
                    if (!args.Value.TryGetProperty("data", out JsonElement dataProp))
                        throw new ArgumentException("PDF data is required");

                    string base64Data = dataProp.GetString() ?? throw new ArgumentException("PDF data cannot be null");
                    ...
                    List<Atom> atoms = sdk.Atom.ProcessPdf(pdfData, extractOcr).GetAwaiter().GetResult();
        ...
        /// <summary>
        /// Registers PDF methods on TCP server.
        /// </summary>
        ...
        {
            server.RegisterMethod("pdf/process", (args) =>
            {
                if (!args.HasValue) throw new ArgumentException("Parameters required");
                if (!args.Value.TryGetProperty("data", out JsonElement dataProp))
                    throw new ArgumentException("PDF data is required");
        ...
        /// <summary>
        /// Registers PDF methods on WebSocket server.
        /// </summary>
